...
<!--            <el-tooltip class="item" effect="dark" content="QQ" placement="top">
              ...
              ></a>
                ...
                <el-row :gutter="12">
                  ...
                  <el-col :span="8">
                    <el-card style="border: 0;" shadow="hover">
                      <h1 class="count-title">分类</h1>
                      <countTo class="count-num"  :startVal="0" :endVal="categoryTotal" :duration="5000" />
                      <!-- <span class="count-num" v-show="!isLogin" >- -</span> -->
                    </el-card>
                  </el-col>
                  <el-col :span="8">
                    <el-card style="border: 0;" shadow="hover">
                      <h1 class="count-title">浏览</h1>
                      <countTo class="count-num"  :startVal="0" :endVal="totalView" :duration="5000" />
                      <!-- <span class="count-num" v-show="!isLogin" >- -</span> -->
                    </el-card>
                  </el-col>
                  </el-row>
...
<script>
import { hotArticleList,getArticleTotal,getViewCountTotal } from "../api/article";
import { getCategoryTotal } from "../api/category";
...
export default {
  ...
  methods: {
    ...
    getCountTotal(){
      // 获取文章总数
      getArticleTotal().then((response) => {
        this.articleTotal = response
      });
      // 获取分类总数
      getCategoryTotal().then((Response) => {
        this.categoryTotal = Response
      });
      // 获取文章总浏览量
      getViewCountTotal().then((Response) => {
